...
export const translations: Partial<Record<LanguageCode, DeepPartial<Translations>>> = {
  en: {
    ...
    companion: {
      name: "Zyno AI Companion",
      greeting: "Hello! I'm Zyno, your AI Entertainment Companion. I'm tuned to your current mode. Ask me anything about what you're watching, or tell me what you want to achieve today!",
      inputPlaceholder: "Ask Zyno or describe what you want...",
  ...
  gu: {
    ...
    companion: {
      name: "ઝાયનો AI સાથી",
      greeting: "નમસ્તે! હું ઝાયનો છું, તમારી AI એન્ટરટેઈનમેન્ટ સાથી. હું તમારા વર્તમાન મોડ માટે સજ્જ છું. તમે જે જોઈ રહ્યા છો તેના વિશે મને કંઈપણ પૂછો, અથવા આજે તમે શું પ્રાપ્ત કરવા માંગો છો તે જણાવો!",
      inputPlaceholder: "ઝાયનોને પૂછો અથવા તમારી જરૂરિયાત જણાવો...",
  ...
  hi: {
    ...
    companion: {
      name: "ज़ायनो AI साथी",
      greeting: "नमस्ते! मैं ज़ायनो हूँ, आपकी AI एंटरटेनमेंट साथी। मैं आपके मौजूदा मोड के लिए तैयार हूँ। आप जो देख रहे हैं उसके बारे में मुझसे कुछ भी पूछें, या बताएं कि आज आप क्या सीखना चाहते हैं!",
      inputPlaceholder: "ज़ायनो से पूछें या अपनी पसंद बताएं...",
  ...
  sa: {
    ...
    companion: {
      name: "ज़ायनो AI सहचरः",
      greeting: "नमस्ते! अहं ज़ायनो, भवतः बुद्धिमान् मनोरञ्जन-सहचरः अस्मि। दृश्यविषये किमपि पृच्छतु अथवा अद्य भवान् किं साधयितुम् इच्छति तत् वदतु!",
      inputPlaceholder: "ज़ायनो पृच्छतु अथवा स्वावश्यकतां लिखतु...",
  ...
  mr: {
    ...
    companion: {
      name: "झायनो AI साथीदार",
      greeting: "नमस्कार! मी झायनो, तुमचा AI मनोरंजन साथीदार आहे. आज तुम्हाला काय पाहायचे आहे किंवा काय साध्य करायचे आहे ते सांगा!",
      inputPlaceholder: "झायनोला विचारा किंवा तुमची गरज लिहा...",
  ...
  te: {
    ...
    companion: {
      name: "జైనో AI సహచరి",
      greeting: "నమస్కారం! నేను జైనో, మీ AI ఎంటర్‌టైన్‌మెంట్ సహచరిని. మీరు ఏమి చూడాలనుకుంటున్నారో లేదా ఏమి సాధించాలనుకుంటున్నారో నాకు చెప్పండి!",
      inputPlaceholder: "జైనోను అడగండి లేదా మీ అవసరాన్ని టైప్ చేయండి...",
  ...
  es: {
    ...
    companion: {
      name: "Compañero Zyno IA",
      greeting: "¡Hola! Soy Zyno, tu compañero de entretenimiento inteligente. Estoy listo en tu modo actual. ¡Pregúntame sobre este contenido o cuéntame qué quieres lograr hoy!",
      inputPlaceholder: "Pregunta a Zyno o escribe lo que necesitas...",
  ...
  fr: {
    ...
    companion: {
      name: "Compagnon Zyno IA",
      greeting: "Bonjour ! Je suis Zyno, votre compagnon IA de divertissement. Je suis connecté à votre mode actuel. Posez-moi vos questions ou dites-moi ce que vous souhaitez accomplir aujourd'hui !",
      inputPlaceholder: "Demandez à Zyno ou décrivez vos envies...",
  ...
  ja: {
    ...
    companion: {
      name: "Zyno AIアシスタント",
      greeting: "こんにちは！AIエンタメアシスタントのZynoです。あなたの現在のモードに合わせてサポートします。動画に関する疑問や、今日達成したい目標を教えてください！",
      inputPlaceholder: "Zynoに質問または要望を入力...",
      surpriseMe: "サプライズ動画",
      eli10: "わかりやすく解説",
      quizMe: "クイズを出題",
      context: "コンテキスト",
  ...
  de: {
    ...
    companion: {
      name: "Zyno AI Begleiter",
      greeting: "Hallo! Ich bin Zyno, dein KI-Unterhaltungsbegleiter. Ich bin auf deinen aktuellen Modus eingestellt. Frag mich nach Inhalten oder sag mir, was du heute erreichen willst!",
      inputPlaceholder: "Frag Zyno oder beschreibe dein Anliegen...",
